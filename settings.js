...
global.owner = process.env.OWNER_NUMBER  || '94764973836' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.VAJIRA-MD=6Z1HGKyZ#c6-Ks5LZqqnVAEBfqyxcwql8RLcwkixOVv2H4q62-TQ || ' ' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94764973836" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'Ravidu' ,
