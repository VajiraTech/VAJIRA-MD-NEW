...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'par ici' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? 'par ici' : process.env.OWNER_NUMBER,   
