...
global.owner = process.env.OWNER_NUMBER  || '254727843864' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=uJsHGYaA#byr-szyqFSmq5ocObO16a2d6s7cCe7996RxOr45glpc ' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "254727843864" : process.env.MODERATORS ,    
