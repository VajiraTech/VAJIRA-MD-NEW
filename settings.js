...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=SQdylbjR#zleFBNnoMgLFd_VJluT2L2UcTqQNByBUcjZmdvEZ18c' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '94760419611' : process.env.OWNER_NUMBER,   
