...
SESSION_ID: process.env.SESSION_ID === 'VAJIRA-MD=nBlhxLaA#tewFxV-3pDsw9ZMu7j-NC2NzJVY0p7lv1VP5EeSIDmQ' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER ===  '923126507341' : process.env.OWNER_NUMBER,   
