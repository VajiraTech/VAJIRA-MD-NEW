...
SESSION_ID: process.env.VAJIRA-MD=CQUhUb4Y#BQgjEJvGkekD8IyUka54TMuqXeEt90qCxSvb4DKzAK8 === undefined ? '' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.94763525276 === undefined ? '' : process.env.OWNER_NUMBER,   
