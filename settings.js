...
global.owner = process.env.OWNER_NUMBER  || 27634988678' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=KUcVCAoL#1ygZTmfyPgRiYJ2m33DO2qZAjJELxyuSOWe5cwchZ2o' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94772801923,94787820101" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'sbonga tech' ,
...
WORK_TYPE: process.env.WORK_TYPE || 'puplic' ,
