...
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=fI8CXIZb#LriJ9EJiyOU2ufZoBI-899DM_2Qt9ox6dBuus5dNNzE' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '94705701134' : process.env.OWNER_NUMBER,   
