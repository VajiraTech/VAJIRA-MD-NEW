...
global.owner = process.env.OWNER_NUMBER  || '923436062975' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=mZMwEQBL#Aj_Prq3WZzpOTiVU-Bky3vBYpKkQvTYOwreJo5uKQus ' ,
