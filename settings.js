...
global.owner = process.env.OWNER_NUMBER  || '94786204938' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=7EtDkKJA#1CRJc9ojofSWIyDNcZcgFZHFX2Jc49vxNXeXT921fMQ' ,
