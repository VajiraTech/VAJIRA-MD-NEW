...
global.owner = process.env.OWNER_NUMBER  || '94766946854' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=LI9WFKoR#i8q4OI7AU_TdIy8QHAcszK-KoR-AVn-d6NFJI8M6GDA ' ,
