import { encodeJson as encodeJson_1, decodeJson as decodeJson_1, encodeBinary as encodeBinary_1, decodeBinary as decodeBinary_1, } from "./(Params)/Comment.js";
...
export function encodeJson(value) {
    ...
    if (value.comment !== undefined)
        result.comment = encodeJson_1(value.comment);
    return result;
}
export function decodeJson(value) {
    const result = getDefaultValue();
    if (value.comment !== undefined)
        result.comment = decodeJson_1(value.comment);
    return result;
}
