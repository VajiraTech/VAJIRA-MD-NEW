import { encodeJson as encodeJson_1, decodeJson as decodeJson_1, encodeBinary as encodeBinary_1, decodeBinary as decodeBinary_1, } from "./(RepliesOptions)/UnkOpts.js";
...
export function encodeJson(value) {
    ...
    if (value.unkopts !== undefined)
        result.unkopts = encodeJson_1(value.unkopts);
    ...
    if (value.unkParam1 !== undefined)
        result.unkParam1 = tsValueToJsonValueFns.int32(value.unkParam1);
    if (value.unkParam2 !== undefined)
        result.unkParam2 = tsValueToJsonValueFns.int32(value.unkParam2);
    return result;
}
export function decodeJson(value) {
    ...
    if (value.unkopts !== undefined)
        result.unkopts = decodeJson_1(value.unkopts);
    if (value.channelId !== undefined)
        result.channelId = jsonValueToTsValueFns.string(value.channelId);
    if (value.videoId !== undefined)
        result.videoId = jsonValueToTsValueFns.string(value.videoId);
    if (value.unkParam1 !== undefined)
        result.unkParam1 = jsonValueToTsValueFns.int32(value.unkParam1);
    if (value.unkParam2 !== undefined)
        result.unkParam2 = jsonValueToTsValueFns.int32(value.unkParam2);
    return result;
}
...
//# sourceMappingURL=RepliesOptions.js.map