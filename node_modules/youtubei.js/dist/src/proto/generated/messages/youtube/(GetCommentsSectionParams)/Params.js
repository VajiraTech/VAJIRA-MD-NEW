import { encodeJson as encodeJson_1, decodeJson as decodeJson_1, encodeBinary as encodeBinary_1, decodeBinary as decodeBinary_1, } from "./(Params)/RepliesOptions.js";
import { encodeJson as encodeJson_2, decodeJson as decodeJson_2, encodeBinary as encodeBinary_2, decodeBinary as decodeBinary_2, } from "./(Params)/Options.js";
...
export function encodeJson(value) {
    ...
    if (value.unkToken !== undefined)
        result.unkToken = tsValueToJsonValueFns.string(value.unkToken);
    if (value.repliesOpts !== undefined)
        result.repliesOpts = encodeJson_1(value.repliesOpts);
    if (value.opts !== undefined)
        result.opts = encodeJson_2(value.opts);
    if (value.page !== undefined)
        result.page = tsValueToJsonValueFns.int32(value.page);
...
export function decodeJson(value) {
    ...
    if (value.unkToken !== undefined)
        result.unkToken = jsonValueToTsValueFns.string(value.unkToken);
    if (value.repliesOpts !== undefined)
        result.repliesOpts = decodeJson_1(value.repliesOpts);
    if (value.opts !== undefined)
        result.opts = decodeJson_2(value.opts);
    if (value.page !== undefined)
        result.page = jsonValueToTsValueFns.int32(value.page);
    if (value.target !== undefined)
