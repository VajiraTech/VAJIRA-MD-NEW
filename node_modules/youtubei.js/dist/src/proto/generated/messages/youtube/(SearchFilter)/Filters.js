...
export function encodeJson(value) {
    ...
    if (value.uploadDate !== undefined)
        result.uploadDate = tsValueToJsonValueFns.int32(value.uploadDate);
    if (value.type !== undefined)
        result.type = tsValueToJsonValueFns.int32(value.type);
    if (value.duration !== undefined)
        result.duration = tsValueToJsonValueFns.int32(value.duration);
    if (value.featuresHd !== undefined)
        result.featuresHd = tsValueToJsonValueFns.int32(value.featuresHd);
    if (value.featuresSubtitles !== undefined)
        result.featuresSubtitles = tsValueToJsonValueFns.int32(value.featuresSubtitles);
    if (value.featuresCreativeCommons !== undefined)
        result.featuresCreativeCommons = tsValueToJsonValueFns.int32(value.featuresCreativeCommons);
    if (value.features3d !== undefined)
        result.features3d = tsValueToJsonValueFns.int32(value.features3d);
    if (value.featuresLive !== undefined)
        result.featuresLive = tsValueToJsonValueFns.int32(value.featuresLive);
    if (value.featuresPurchased !== undefined)
        result.featuresPurchased = tsValueToJsonValueFns.int32(value.featuresPurchased);
    if (value.features4k !== undefined)
        result.features4k = tsValueToJsonValueFns.int32(value.features4k);
    if (value.features360 !== undefined)
        result.features360 = tsValueToJsonValueFns.int32(value.features360);
    if (value.featuresLocation !== undefined)
        result.featuresLocation = tsValueToJsonValueFns.int32(value.featuresLocation);
    if (value.featuresHdr !== undefined)
        result.featuresHdr = tsValueToJsonValueFns.int32(value.featuresHdr);
    if (value.featuresVr180 !== undefined)
        result.featuresVr180 = tsValueToJsonValueFns.int32(value.featuresVr180);
    return result;
}
export function decodeJson(value) {
    const result = getDefaultValue();
    if (value.uploadDate !== undefined)
        result.uploadDate = jsonValueToTsValueFns.int32(value.uploadDate);
    if (value.type !== undefined)
        result.type = jsonValueToTsValueFns.int32(value.type);
    if (value.duration !== undefined)
        result.duration = jsonValueToTsValueFns.int32(value.duration);
    if (value.featuresHd !== undefined)
        result.featuresHd = jsonValueToTsValueFns.int32(value.featuresHd);
    if (value.featuresSubtitles !== undefined)
        result.featuresSubtitles = jsonValueToTsValueFns.int32(value.featuresSubtitles);
    if (value.featuresCreativeCommons !== undefined)
        result.featuresCreativeCommons = jsonValueToTsValueFns.int32(value.featuresCreativeCommons);
    if (value.features3d !== undefined)
        result.features3d = jsonValueToTsValueFns.int32(value.features3d);
    if (value.featuresLive !== undefined)
        result.featuresLive = jsonValueToTsValueFns.int32(value.featuresLive);
    if (value.featuresPurchased !== undefined)
        result.featuresPurchased = jsonValueToTsValueFns.int32(value.featuresPurchased);
    if (value.features4k !== undefined)
        result.features4k = jsonValueToTsValueFns.int32(value.features4k);
    if (value.features360 !== undefined)
        result.features360 = jsonValueToTsValueFns.int32(value.features360);
    if (value.featuresLocation !== undefined)
        result.featuresLocation = jsonValueToTsValueFns.int32(value.featuresLocation);
    if (value.featuresHdr !== undefined)
        result.featuresHdr = jsonValueToTsValueFns.int32(value.featuresHdr);
    if (value.featuresVr180 !== undefined)
        result.featuresVr180 = jsonValueToTsValueFns.int32(value.featuresVr180);
    return result;
}
