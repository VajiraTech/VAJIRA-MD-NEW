import { encodeJson as encodeJson_1, decodeJson as decodeJson_1, encodeBinary as encodeBinary_1, decodeBinary as decodeBinary_1, } from "./(PeformCommentActionParams)/TranslateCommentParams.js";
...
export function encodeJson(value) {
    ...
    if (value.unkNum !== undefined)
        result.unkNum = tsValueToJsonValueFns.int32(value.unkNum);
    ...
    if (value.translateCommentParams !== undefined)
        result.translateCommentParams = encodeJson_1(value.translateCommentParams);
    return result;
}
export function decodeJson(value) {
    ...
    if (value.unkNum !== undefined)
        result.unkNum = jsonValueToTsValueFns.int32(value.unkNum);
    if (value.commentId !== undefined)
    ...
    if (value.translateCommentParams !== undefined)
        result.translateCommentParams = decodeJson_1(value.translateCommentParams);
    return result;
}
export function encodeBinary(value) {
    ...
    if (value.translateCommentParams !== undefined) {
        ...
        result.push([31, { type: WireType.LengthDelimited, value: encodeBinary_1(tsValue) }]);
    }
...
//# sourceMappingURL=PeformCommentActionParams.js.map