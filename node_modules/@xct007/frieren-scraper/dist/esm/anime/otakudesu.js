import { Cheerio, Axios } from "../Utils.js";
import { OtakudesuBaseUrl } from "../Constant.js";
async function latest() {
    try {
        const { data } = await Axios.get(OtakudesuBaseUrl + "/ongoing-anime").catch((e) => e?.response);
        const $ = Cheerio(data);
        const _temp = [];
        $(".venz > ul > li").each((i, e) => {
