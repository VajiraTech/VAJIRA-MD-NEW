...
class Proto {
    static encodeVisitorData(id, timestamp) {
        const buf = youtube_1.VisitorData.toBinary({ id, timestamp });
        return encodeURIComponent((0, Utils_1.u8ToBase64)(buf).replace(/\+/g, '-').replace(/\//g, '_'));
    }
        ...
        const data = {
            context: {
                client: {
                    ...
                    clientVersion: Constants_1.CLIENTS.YTSTUDIO_ANDROID.VERSION
                }
            },
            target: video_id
        };
