...
class LiveChatTickerPaidMessageItem extends helpers_1.YTNode {
    constructor(data) {
        ...
        this.author = {
            ...
            badges: (0, helpers_1.observe)([]).as(LiveChatAuthorBadge_1.default, MetadataBadge_1.default),
            is_moderator: null,
            is_verified: null,
        ...
        this.show_item = index_1.default.parse((_b = (_a = data.showItemEndpoint) === null || _a === void 0 ? void 0 : _a.showLiveChatItemEndpoint) === null || _b === void 0 ? void 0 : _b.renderer);
